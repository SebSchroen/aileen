require(['bowser', 'underscore', 'backbone', 'semver', 'react', 'react-dom', 'html-react-parser', 'libraries/mediaelement-and-player', 'libraries/SCORM_API_wrapper', 'libraries/lzma-min', 'libraries/lzma_worker-min.js', 'libraries/js-cookie.js', 'libraries/jquery.keycombo'], (function (Bowser, _$1, Backbone$1, semver, React, ReactDOM, HTMLReactParser, mediaelementAndPlayer, pipwerks, lzmaMin, lzma_workerMin_js, Cookies, jquery_keycombo) { 'use strict';
  ...
  class ScormWrapper {
    ...
    setIncomplete() {
      this.setValue(this.isSCORM2004() ? 'cmi.completion_status' : 'cmi.core.lesson_status', COMPLETION_STATE$1.INCOMPLETE.asLowerCase);
      if (this.commitOnStatusChange && !this.commitOnAnyChange) this.commit();
    }
    setCompleted() {
      this.setValue(this.isSCORM2004() ? 'cmi.completion_status' : 'cmi.core.lesson_status', COMPLETION_STATE$1.COMPLETED.asLowerCase);
      if (this.commitOnStatusChange && !this.commitOnAnyChange) this.commit();
    }
    setPassed() {
      if (this.isSCORM2004()) {
        this.setValue('cmi.completion_status', COMPLETION_STATE$1.COMPLETED.asLowerCase);
    ...
    setFailed() {
      if (this.isSCORM2004()) {
        ...
        if (this.setCompletedWhenFailed) this.setValue('cmi.completion_status', COMPLETION_STATE$1.COMPLETED.asLowerCase);
      } else {
  ...
  class ExtaView extends Backbone.View {
    ...
    render() {
      ...
      ReactDOM__default["default"].render(React__default["default"].createElement(templates.extra, this.model.toJSON()), this.el);
    }
  }
  ExtaView.template = 'extra';
  var ExtraView = __AMD("extensions/adapt-extra/js/ExtraView", ExtaView);
  ...
  __AMD("extensions/adapt-extra/js/adapt-extra", new Extra());
  ...
  register("extra", function Extra(props) {
    const {
      _extra
    } = props;
    return React__default["default"].createElement(React__default["default"].Fragment, null, _extra.text && React__default["default"].createElement("div", {
      className: "extra__text",
      dangerouslySetInnerHTML: {
        __html: compile(_extra.text)
      }
    }), _extra._items.length > 0 && React__default["default"].createElement("div", {
      className: "extra__items"
    }, _extra._items.map(({
      title,
      body,
      _graphic,
      ...
      key: index,
      className: classes(['extra__item', _classes])
    }, title && React__default["default"].createElement("div", {
      className: "extra__item-title"
    }, React__default["default"].createElement("div", {
